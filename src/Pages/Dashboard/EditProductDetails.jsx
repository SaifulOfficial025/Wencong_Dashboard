...
function EditProductDetails() {
  ...
  return (
    <div className="p-4 font-sans max-w-full mx-auto text-black">
      ...
      <div className="mb-4">
        <Link
          to="/dashboard/master_data/product"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-rose-50 border border-rose-100 rounded-md focus:outline-none focus:ring-2 focus:ring-[#F04E24]"
                />
              </div>
              <div>
                <label
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-3 py-2 bg-rose-50 border border-rose-100 rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-[#F04E24]"
                  >
