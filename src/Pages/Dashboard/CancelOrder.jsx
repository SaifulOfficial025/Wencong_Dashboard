...
// Main CancelOrder functional component
const CancelOrder = () => {
  return (
        ...
        <div className=" mx-auto bg-white dark:bg-white rounded-md shadow-md">
          ...
          <div className="bg-[#F04E24] dark:bg-[#F04E24] text-white dark:text-white py-3 px-5 flex items-center justify-between rounded-t-md">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Status badge */}
              <span className="bg-[#FF9900] dark:bg-[#FF9900] text-white dark:text-white py-1 px-3 rounded-sm text-sm font-medium">Cancel</span>
            </div>
          ...
          <div className="p-5">
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-2">
                ...
                {/* Removed Add New button as per the new image */}
              </div>
                  ...
                  <tbody className="bg-white dark:bg-white divide-y divide-gray-200 dark:divide-gray-200">
                    ...
                    <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-white dark:even:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700 dark:text-gray-700">
                        <input type="number" className="w-20 border-gray-300 dark:border-gray-300 rounded-md shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm bg-white dark:bg-white text-gray-800 dark:text-gray-800 p-1" defaultValue="15" /> {/* Made editable */}
                      </td>
                      <td className="px-4 py-3 text-sm text-gray-700 dark:text-gray-700">
                        <select className="border-gray-300 dark:border-gray-300 rounded-md shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm bg-white dark:bg-white text-gray-800 dark:text-gray-800 p-1"> {/* Made editable */}
