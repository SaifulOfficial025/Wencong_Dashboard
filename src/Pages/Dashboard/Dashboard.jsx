  ...
  const menuItems = [
  {
    items: [
      ...
      },
      {
        ...
        path: "sales_report",
        children: [
          { name: "Agent Sales Report", path: "sales_report/agent_sales_report" },
          { name: "Item Sales Report", path: "sales_report/item_sales_report" },
          { name: "Stock Remain Report", path: "sales_report/stock_remain_report" },
          { name: "Area Sales Report", path: "sales_report/area_sales_report" },
          { name: "Performance Report", path: "sales_report/performance_report" },
        ],
      },
      {
        name: "Settings",
        ...
        children: [
          ...
          { name: "System Settings", path: "settings/system_settings" },
        ],
      },
      {
        name: "Master Data",
        ...
        path: "master_data",
        children: [
          { name: "Sales Agent", path: "master_data/sales_agent" },
          { name: "Sales Agent Group", path: "master_data/sales_agent_group" },
                ...
                <div className="flex items-center gap-3 overflow-hidden">
                  ...
                  <span
                    className={`transform text-[#DE472D] font-medium transition-all duration-500 ${
                      isCollapsed ? "opacity-0 -translate-x-4 w-0" : "opacity-100 translate-x-0"
                    } whitespace-nowrap`}
                  >
                    {item.name}
                  </span>
          ...
          <div className="h-full px-4 flex items-center justify-between w-full">
            <div className="flex items-center gap-4 text-white">
              ...
              <div className="flex flex-col">
                <span className="text-white font-bold text-xl">{selectedItem}</span>
