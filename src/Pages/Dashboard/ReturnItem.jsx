...
// Main ReturnItem functional component
const ReturnItem = () => {
  return (
        ...
        <div className=" mx-auto bg-white dark:bg-white rounded-md shadow-md">
          ...
          <div className="bg-[#F04E24] dark:bg-[#F04E24] text-white dark:text-white py-3 px-5 flex items-center justify-between rounded-t-md">
            ...
            <div className="flex items-center gap-2">
              {/* Title of the page */}
              <h2 className="font-semibold text-lg">Return Item</h2>
              {/* Status badge */}
              <span className="bg-[#FF9900] dark:bg-[#FF9900] text-white dark:text-white py-1 px-3 rounded-sm text-sm font-medium">Return</span>
            </div>
