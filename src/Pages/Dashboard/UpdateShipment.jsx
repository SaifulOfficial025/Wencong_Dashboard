        ...
        <div className=" mx-auto bg-white dark:bg-white rounded-md shadow-md mt-6 p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <select id="courier" className="block w-full rounded-md border-gray-300 dark:border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm bg-white dark:bg-white text-gray-800 dark:text-gray-800 p-2">
