...
// Main UpdateShipment functional component
const UpdateShipment = () => {
  return (
      ...
      <div className="min-h-screen p-4 font-sans">
        ...
        <div className="mx-auto bg-white dark:bg-white rounded-md shadow-md">
          ...
          <div className="bg-[#F04E24] dark:bg-[#F04E24] text-white dark:text-white py-3 px-5 flex items-center justify-between rounded-t-md">
            ...
            <div className="flex items-center gap-2">
              {/* Title of the page */}
              <h2 className="font-semibold text-lg">Update Shipment</h2>
              {/* Status badge */}
              <span className="bg-[#FFE3B8] dark:bg-[#FFE3B8] text-black dark:text-black py-1 px-3 rounded-sm text-sm font-medium">Awaiting Shipment</span>
            </div>
          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select id="promotion" className="w-full px-3 py-2 bg-rose-50 text-black border border-rose-100 rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
          ...
          {/* Bottom Actions Section (Combine Order, Close, Save) */}
          <div className="px-5 py-4 flex justify-between items-center bg-gray-100 dark:bg-gray-100">
        ...
        {/* Shipment Details Section (New Section) */}
        <div className=" mx-auto bg-white dark:bg-white rounded-md shadow-md mt-6 p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <select id="courier" className="w-full px-3 py-2 bg-rose-50 text-black border border-rose-100 rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
            ...
            <div>
              ...
              <input
                ...
                readOnly // As per image, this appears read-only
              />
            </div>
          </div>
          ...
          {/* Shipment Details Action Buttons */}
          <div className="flex justify-end gap-2 mt-6">
            <button className="bg-white dark:bg-white border border-gray-300 dark:border-gray-300 text-gray-700 dark:text-gray-700 py-2 px-4 rounded-md text-sm hover:bg-gray-200 dark:hover:bg-gray-200 transition-colors duration-200">Reject</button>
            <button className="bg-[#F04E24] dark:bg-[#F04E24] text-white dark:text-white py-2 px-4 rounded-md text-sm hover:bg-[#c23c23] dark:hover:bg-[#c23c23] transition-colors duration-200">Approve</button>
          </div>
        </div>
      </div>
  );
